"""Post-hoc calibration methods for knowledge-tracing predictions.
...
class ConceptAwareIsotonic:
    ...
    per-concept residual miscalibration is non-uniform (Exp D hypothesis)
    ...
    shrinkage_lambda : float
        ...
        tuned. ``scripts/tune_lambda_shrinkage.py`` sweeps it per
        (dataset, model) for anyone who wants to.
    """
